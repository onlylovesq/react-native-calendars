...
class Calendar extends Component {
  static propTypes = {
    ...
    markedMessages: PropTypes.object,
  ...
  updateMonth(day, doNotTriggerListeners) {
    ...
    if (!doNotTriggerListeners) {
      const currMont = day.clone().clone();
    ...
    if (
      ...
      dayComp = (
        <DayComp
          ...
          markMessage={this.getMessageMarking(day)}
        >
          {date}
        </DayComp>
      );
  ...
  getMessageMarking(day) {
    if (!this.props.markedMessages) {
      return false;
    }
    const messages =
      this.props.markedMessages[day.toString('yyyy-MM-dd')] || EmptyArray;
